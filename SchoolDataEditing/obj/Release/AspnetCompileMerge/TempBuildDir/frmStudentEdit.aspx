                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="row mt-3" id="divQuestion3Part2Optional1" style="display: none" runat="server">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row mt-3" style="display: none" id="divQuestion3Part2Optional3" runat="server">
                                        <div class="col-md-6">
                                            <label style="font-size: medium">પ્રવેશ ન લેવાનું  નું કારણ પસંદ કરો</label>
                                        </div>
                                        <div class=" col-md-4">
                                            <asp:DropDownList CssClass="form-control" runat="server" ID="reasonForLeaving">
                                    ...
                                    <div class="row mt-3" id="old2NewDISE" runat="server">
                                        <div class="col-md-8">
                                            <label for="newDISECode" style="font-size: medium">અહીં નવો DISE કોડ દાખલ કરો</label>
                                        </div>
                                        <div class=" col-md-4">
                                            <asp:TextBox runat="server" MaxLength="11" ID="newDISECode" MinLength="11"></asp:TextBox>
                            ...
                            <div class="row" style="margin-top: 10px">
                                ...
                                <div class="row" id="divConsentLetterSection" runat="server">
                                    ...
                                    <div class="col-md-2 mt-3">
                                        ...
                                        <div id="previewContainer" style="margin-top: 10px;">
                                            <img id="imgPreview" style="display: none; max-width: 100%;" />
                                            <p id="fileInfo"></p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="row mt-3" id="divBankStatementSection" runat="server" style="display: none">
                                    ...
                                    <div class=" col-md-2">
                                        ...
                                        <div id="previewContainer1" style="margin-top: 10px;">
                                            <img id="imgPreview1" style="display: none; max-width: 100%;" />
                                            <p id="fileInfo1"></p>
                                        </div>
                                    </div>
                                </div>
