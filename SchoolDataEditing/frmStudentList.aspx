<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmStudentList.aspx.cs" Inherits="SchoolDataEditing.frmStudentList" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                * આપના જીલ્લાના નીચેના વિદ્યાર્થીઓને વર્ષ-૨૦૨૩ માં મુખ્યમંત્રી જ્ઞાન સાધના મેરીટ સ્કોલરશીપ યોજના અંતર્ગત સ્કોલરશીપના પ્રથમ બન્ને હફ્તા મળી ગયેલ છે. આ તમામ વિદ્યાર્થીઓને સ્કોલરશીપના ત્રીજા(૩) હ્ફ્તાની રકમ ની ફાળવણી કરવા આપે આ તમામ વિદ્યાર્થીની જરૂરી તમામ વિગતની ચકાસણી કરી તેમનું ફોર્મ વેરીફીકેશન પૂર્ણ કરવાનું રહેશે.
<br />
                                <br />* જે વિદ્યાર્થીના વેરીફીકેશનની કામગીરી પૂર્ણ થશે તેમ તેમ એ આપને ડાબી બાજીમાં Student list – completed માં દેખાશે. વધુ વિગત માટે માર્ગદર્શક PDF બાજુમાં મુકેલ છે.
                            </div>
                            <br />
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="card-title">જે વિદ્યાર્થી એ શાળા બદલી હોય એમને આ ફોર્મ ડાઉનલોડ કરવાનું રહેશે.</h5>
                                <asp:Button runat="server" OnClick="Concent_Click" CssClass="btn btn-success" ID="Concent" Text="Concent Letter" />
                            </div>
                            <div class="row mt-3">
                                <div class="d-flex justify-content-end align-items-center">
