...
{
    public partial class frmStudentList : Page
    {
        ...
        protected void Concent_Click(object sender, EventArgs e)
        {
            Response.ContentType = "Application/pdf";
            Response.AppendHeader("Content-Disposition", "attachment; filename=વિદ્યાર્થી પ્રવેશ ફોર્મ (જ્ઞાનસાધના).pdf");
            Response.TransmitFile(Server.MapPath("~/Media/વિદ્યાર્થી પ્રવેશ ફોર્મ (જ્ઞાનસાધના).pdf"));
            Response.End();
        }
